...
//namespace Assets.Scenes.DOTween.Scripts.Managers
//{
    public class DOTweenManager : MonoBehaviour
    {
        ...
        [Range(1.0f, 500.0f), SerializeField] private float _scaleMultiplier     = 3.0f;
...
//}   // namespace Assets.Scenes.DOTween.Scripts
