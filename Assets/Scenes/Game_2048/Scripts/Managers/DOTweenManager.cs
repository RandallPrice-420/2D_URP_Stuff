...
namespace Assets.Scenes.Game2048.Scripts.Managers
{
    public class DOTweenManager : MonoBehaviour
    {
        ...
        [SerializeField, Range(0.5f,  10.0f)] private float _moveDuration        = 1.0f;
        [SerializeField, Range(1.0f, 500.0f)] private float _scaleMultiplier     = 3.0f;
        [SerializeField, Range(1.0f,  10.0f)] private float _colorChangeDuration = 1.0f;
